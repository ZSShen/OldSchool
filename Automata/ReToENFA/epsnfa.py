...
def union(s1,t1,s2,t2):
    ...
    addEdge(start, epssymbol, s1)
    addEdge(start, epssymbol, s2)
    addEdge(t1, epssymbol, end)
    addEdge(t2, epssymbol, end)
...
def clo(s,t):
    ...
    addEdge(start, epssymbol, s)
    addEdge(t, epssymbol, end)
    addEdge(start, epssymbol, end)
